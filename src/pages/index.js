...
return (
  ...
  <rect width="124" height="54" fill="white" transform="translate(0 0.5)"/>
          ...
          <div class="col-8 flex justify-center padding-sm">
            <h2 class="text-xxxl text-nowrap">Join the community</h2>
          </div>
        </div>
        <div class="grid border-bottom">
        ...
        <div class="grid border-top">
          <div class="col-6">
            <a class="btn btn--primary btn--lg height-100%" href="openseas.io" target="_blank">Discord</a>
          </div>
          <div class="col-6">
            <a class="btn btn--primary btn--lg height-100%" href="openseas.io" target="_blank">Twitter</a>
          </div>
        </div>
      </div>
    </section>
